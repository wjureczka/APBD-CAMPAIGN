...
namespace APBD_CAMPAIGN.Migrations
{
    ...
    [Migration("20200611195238_DeleteAccessTokenFromDb")]
    partial class DeleteAccessTokenFromDb
    {
            ...
            modelBuilder.Entity("APBD_CAMPAIGN.Models.Campaign", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdCampaign = 1,
                            EndDate = new DateTime(2020, 6, 11, 21, 52, 38, 455, DateTimeKind.Local).AddTicks(8885),
                            FromIdBuilding = 1,
                            IdClient = 1,
                            PricePerSquareMeter = 50m,
                            StartDate = new DateTime(2020, 6, 11, 21, 52, 38, 449, DateTimeKind.Local).AddTicks(6032),
                            ToIdBuilding = 2
                        });
                });
